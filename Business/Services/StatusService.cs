...
//    public async Task<StatusResult<bool>> CreateAsync(StatusDto formData)
//    {
//        if (formData == null)
...
//    public async Task<StatusResult<Status>> GetStatusAsync(string value)
//    {
...
//    public async Task<StatusResult<bool>> UpdateAsync(StatusDto formData)
//    {
//        if (formData == null)
...
//    public async Task<StatusResult<bool>> DeleteAsync(StatusDto formData)
//    {
//        var entity = formData.MapTo<StatusEntity>();
