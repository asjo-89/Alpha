...
namespace Data.Interfaces
{
    public interface IBaseRepository<TEntity, TModel> where TEntity : class
    {
        ...
        Task<RepositoryResult<IEnumerable<TEntity>>> GetAllAsync(bool orderByDescending = false, Expression<Func<TEntity, object>> orderBy = null!, Expression<Func<TEntity, bool>> filterBy = null!, params Expression<Func<TEntity, object>>[] includes);
        ...
        Task<RepositoryResult<TEntity>> GetAsync(Expression<Func<TEntity, bool>> filterBy = null!, params Expression<Func<TEntity, object>>[] includes);
